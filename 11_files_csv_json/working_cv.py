...
# print(os.getcwd()) #
# path_file_to_csv=os.path.join(os.getcwd(),"11_files_csv_json","students.csv")
# print(path_file_to_csv) #
# # # #запис
...
# ]
# # # # "," - one ceil ,   ";" - many ceils
# path_file_to_csv1=os.path.join(os.getcwd(),"11_files_csv_json","painters.csv")
