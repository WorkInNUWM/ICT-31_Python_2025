...
# path_to=os.path.join(os.path.abspath("."),'test_dir') #10_files
# print(path_to)
# # using relative path
...
# # using absolute
# path_file_for_copy=os.path.abspath("E:\\Tetiana\\NUWM_2025\\ICT-31_Python"+'methods_os.txt')
...
import glob
# пошук файлів в поточному каталоці => 10_files
